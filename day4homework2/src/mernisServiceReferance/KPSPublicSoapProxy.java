...
public class KPSPublicSoapProxy implements mernisServiceReferance.KPSPublicSoap {
  private String _endpoint = null;
  private mernisServiceReferance.KPSPublicSoap kPSPublicSoap = null;
  ...
  private void _initKPSPublicSoapProxy() {
    try {
      kPSPublicSoap = (new mernisServiceReferance.KPSPublicLocator()).getKPSPublicSoap();
  ...
  public mernisServiceReferance.KPSPublicSoap getKPSPublicSoap() {
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
