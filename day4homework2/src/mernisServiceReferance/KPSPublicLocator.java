...
public class KPSPublicLocator extends org.apache.axis.client.Service implements mernisServiceReferance.KPSPublic {
    ...
    public mernisServiceReferance.KPSPublicSoap getKPSPublicSoap() throws javax.xml.rpc.ServiceException {
    ...
    public mernisServiceReferance.KPSPublicSoap getKPSPublicSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mernisServiceReferance.KPSPublicSoapStub _stub = new mernisServiceReferance.KPSPublicSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mernisServiceReferance.KPSPublicSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                mernisServiceReferance.KPSPublicSoapStub _stub = new mernisServiceReferance.KPSPublicSoapStub(new java.net.URL(KPSPublicSoap_address), this);
                _stub.setPortName(getKPSPublicSoapWSDDServiceName());
                return _stub;
            }
        }
